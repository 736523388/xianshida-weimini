...
Page({
  ...
  skip_details:function(e){
    wx.navigateTo({
      url: '/pages/my/my_optometry_details/my_optometry_details?id='+e.currentTarget.dataset.id,
    })
  },
  ...
  onShow: function() {
    ...
    isLogin(() => { })
    wx.request({
      url: app.globalData.urlhost + '/api/user.optometry/lists',
      data: {
        token: wc.get('token'),
      },
      header: {
